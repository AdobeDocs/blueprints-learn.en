...
1. **Business objective links** -- Every business objective link in the pattern file points to an existing file under `/help/blueprints/business-objectives/`. Use workspace search or file reading to confirm each target file exists.
