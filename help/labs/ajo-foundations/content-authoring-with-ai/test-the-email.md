...
![](assets/V-3-ldo9TsAmu0LV9fLIn_image.png)

2. Add your own personal email address.
...
2. Add Sublect Line Prefix
   1. Variant 1: Above 40 
   2. Variant 2: Below 40 
3. Click **Send Proof**. You will get green confirmation message "**Proofs sent successfully**"

![](assets/vVrQl8t_JkDe7m2wFduz1_image.png)
...
![](assets/vvQJXZvHzoaHNF0wdX1da_image.png)
...
![](assets/EunCarEY4umZPAeD1SMQd_image.png)
...
![](assets/Gt4rZTl3d73a6cLt6hwNt_image.png)

You will notice your proof email details. 

![](assets/IBsZRplHe1eAKVRuCyqY2_image.png)
