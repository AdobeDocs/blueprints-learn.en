...
2. Click **View **to lookup up the profile

![](assets/yhLnKD84tNVUxSLTan2bG-20251223-172059.png)



# Validate Profile on Hub

3. Click on the **Profile ID** to open the profile
4. Click on the **Attributes **tab first and the ***Hub ***radio button to see the **Hub Profile**

![](assets/woTrja2xouGiFi_IJ-iro-20251107-005528.png)

****

## Validate Events

5. Click on **Events **in the top nav and you can see the event you just sent in

![](assets/i10MOG8a9_zH1XaOgtwuC-20251222-222838.png)

## Validate Segments

### Via JSON

6. Click on the **Attributes **header and View **JSON**

![](assets/2jS2liqd8p8Bb-yRTLTfn-20251111-223239.png)

7. Find **segmentMembership**.  It should look like this (your IDs will be different)
...
8. An easier way to validate the Profile has qualified for the Audiences is by looking at the **Audience Membership** tab (you should see at least these):
   - dep: Any Event Streaming (within the hour)
   - dep: Any Event Edge (within the hour)

![](assets/sKN3WoWhsJzIOwW_QyX_j-20251120-025018.png)
