...
![](assets/1epXqlBD_OBQizW0WK3qX_image.png "Configure IP pool details")
...
2. Scroll up and click **Submit**.
3. When you are done you should see two email channel configurations, both likely in a "processing" state.
