...
![](assets/px_qPzeyFejTc_8hjTOkT_create-a-new-audience-use-the-billing-statement-event-card.png)
...
![](assets/z60-lRWO6zEQPsJGtVE-m_change-t.png)
...
>
![](assets/uzn0zTYzRuEOzJ01IlEC6_counts-only-this-counts-each-event-as-1.png)
>
>Both can be used together if desired
>
![](assets/fGNSR67CZBkgdLe34m3fh_both-can-be-used-together-if-desired.png)
...
![](assets/LcaeHU_E4Z21gQIQtPK-v_once-it-is-highlighted-click-copy.png)
...
![](assets/YdSYiI-b9VRZ_7jXI8ncd_copy-the-pseudo-code-into-the-description.png)
...
2. In Attributes, search for Plan Name
3. Add Plan Name (Plan Name)  
4. Select "Ultimate".  Change to Does Not Equal
...
![](assets/ZPDWk4jACy7PbG_eb9q22_select-22ultimate-22-change-to-does-not-equal.png)



5\. Click on Audiences --> Experience Platform. Drag Billing Usage Sum > 140 GB and Billing Usage Avg >= 20 GB next to Plan Name.

![](assets/YKV8tSsAjn1gkShNtXYOm_20-gb-next-to-plan-name.png)
...
![](assets/Yj0bYLNwN7NYvkH1evela_plan-name.png)
