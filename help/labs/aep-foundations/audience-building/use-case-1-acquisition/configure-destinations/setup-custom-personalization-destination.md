...
2. In the top rail click on **Catalog**
3. Next select the category of **Personalization**
4. In the middle of the screen you should see the destination titled **Custom Personalization with Attributes. **Click the **Set up** button on that card.

![](assets/pDFpcMRYTDKx5WatQ37KL-20251126-155614.png "Browse destination catalog for Custom Personalization destination")
...
2. Integration Alias -> **edgeAlias**
3. Datastream ID -> *select the datastream name you created previously*
4. When done click the **Next **button

![](assets/k6ssA7rSRDSQ0QTi0h827-20251202-152043.png "Fill in destination details")
...
![](assets/ePk_1qXmv-5VJ8sQO5o_F-20251202-152724.png "Select governance policy")
...
![](assets/vZp41fJ3X_72FA5coONQt-20251202-153115.png "Successful PZN destination creation")
...
![](assets/q6HStXiyBFeZfO9njuXO--20251202-153325.png "Select PZN destination")



Select **All Audiences** and click **Next**

![](assets/BVDjpTU7fB3HxE7nGUVHA-20251202-160029.png "Select PZN Audiences")
...
![](assets/uge7zDALhElTgjs4kmSje-20251202-161742.png "Create PZN Mapping")
...
![](assets/97dq54NjiTnWvqUKZgg78-20251202-162224.png "Review and Publish PZN Destination")
