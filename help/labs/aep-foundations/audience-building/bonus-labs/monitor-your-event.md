...
![](assets/JhXXw8zJa8U6LH9Tqozdj_go-to-adobe-experience-platform-greater-assurance-greater-create-session.png)



2\. Click on the **Start **button

![](assets/cOkdH6YSAkhMvrCtvjEBe_start.png)
...
![](assets/QnynlFfHRWLh2v26hkel__next.png)

4\. Copy the link somewhere you can reference later

5\. Click the **Done **button

![](assets/9S1Uju5MONpZh8onHWUR5_copy-link.png)



6\. Navigate to **Settings**

![](assets/n-ADAXZy_lxxLyKc0x1oi-gxaSyFh9sQmczCtvIBRll-20241025-193023.png "Click on settings")



7\. Enable **Event Transactions **and **Edge Delivery **by clicking on the **+ **button, then **Done**

![](assets/mOYnYAh0_GDCKe-79Aw6-_done.png)
...
2. We would just use the [`efa4a9ed-02d8-4647-80fa-f01a5be273d0`](https://www.adobe.com/?adb_validation_sessionid=efa4a9ed-02d8-4647-80fa-f01a5be273d0)value, not the full url

![](assets/CXGFont6YjTCwCl7M51Dt_populate-the-x-adobe-aep-validation-token.png)
...
![](assets/0rdMwZbJLRHIaO5HAdn5i_filter-using-search.png)



Select an event and open any messages if needed on the right rail.

![](assets/G5MKtQVwQ6FHtz1cAF9Zq_expand-messages.png)
...
![](assets/OHNH2o7RV83SPvIGew6fv_select-each-event.png)
