...
2. 15
3. Minutes
4. Change to Streaming Evaluation

Save as **Order Event Streaming (within 15 minutes)**



![](assets/1h0MQ-tRlcIDtKFustwl4_image.png)
...
![](assets/4i7TVl1ONe8sIvKxbi_k5_image.png)
...
![](assets/etDXZ_XQnwts5CiaLLjQ__image.png)

### Mapping

Leave Mapping alone and click Next

![](assets/JafCnlfB55WIfkwUfaiPd_image.png)
...
4. **API Request** --> `Create Order Event`

![](assets/Kjsq3C7LCIYktN_w43tBv_create-web-event-api-request.png)
...
2. In the right rail copy and save the **Dataflow ID** values somewhere you can reference later

>[!NOTE]
>Click in an empty space on the row.  DO NOT click on the blue links!

![](assets/YZq5xpIpR2udKhtI8osBm_screenshot-2024-10-24-at-73808-pm.png "Web Dataflow and Dataset IDs")
...
![](assets/W0BXKhP2HZxF1f_Tguisg_final-order-api-request.png)
...
![](assets/IkJ9XpJRVvnPsxIep6jWG_successful-web-event-send.png)
...
2. Validate the Profile has qualified for the Segments (it may take a few minutes). It should appear in seconds to minutes.
   1. Order Event Streaming (within 15 minutes)
3. Check your webhook to see if the Destination has notified the webhook of a Segment "realized".  It should appear in 5-10 minutes.
4. After 15-30 minutes, you can even check your dataset with the following:
