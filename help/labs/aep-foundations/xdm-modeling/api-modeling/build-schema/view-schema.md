...
![](assets/n-ADAXZy_lxxLyKc0x1oi-F3oAgyOHSOSBIs4fgGXuA-20241023-210301.png "UI View of the Sample Customer Schema")
...
![](assets/bWp5YMQCGvXqMB7mo1yOG_step-5-get-customer-account-schema.jpeg "Step 5 - Get Customer Account Schema")



Example of your final request after adding the `$meta:altId`

![](assets/6jnAifruj2a5FKKmwFo0H_final-step-5-request.png "Final Step 5 Request")
...
![](assets/5fC_lddj-b_MOMwVdMVxd_sample-customer-account-schema.png "Sample Customer Account Schema")
