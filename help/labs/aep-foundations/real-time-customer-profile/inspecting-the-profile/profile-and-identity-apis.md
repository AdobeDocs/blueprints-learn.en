...
x-api-key<font color="#fcb900">* </font>`string`
...
Authorization<font color="#fcb900">* </font>`string`
...
2. Click on the **Entity Lookup (attributes)** request to open it
3. Execute the call by clicking the **Send **button

![](assets/lV7mJTqL9wBN_3AYLtWMu_profile-entity-lookup-attributes-api.png "Profile Entity Lookup (attributes) API")
...
![](assets/Gogu7oCC_Ur7P0oenhGc2_successful-profile-entity-attributes-api-response.png "Successful Profile Entity (attributes) API Response")
...
2. Check the box next to **Key **named **fields**
3. Execute the request by clicking the **Send **button

![](assets/-K7cofy2u8OoATEVOziBO_profile-entity-lookup-attributes-with-filter-enabled.png)
...
![](assets/a8YtaW9-H7Ohxku-jR6Ew_successf.png "Successful Profile Entity Lookup (attributes) API Response with filter enabled")
...
![](assets/owff9D4O4Z3mJMW9Qb9SO_profile-entity-lookup-events.png)
...
![](assets/Fsmu_LLZG3u2wYuw046kQ_successful-profile-entity-lookup-events-api-response.png "Successful Profile Entity Lookup (events) API Response")
...
![](assets/-1k_LbDoa5Tnv27Y8diQW_profile-entity-lookup-for-experience-events.png "Profile Entity Lookup for Experience Events")
...
![](assets/Xls-UKprd9UcF0GRhQ701_list-linked-identities-api.png "List Linked Identities API")

A successful response should look like the below screenshot



![](assets/ntTE6k_gCE1tBuGkhecfU_you-ll-n.png)
