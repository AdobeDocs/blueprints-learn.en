...
![](assets/zCLbt7QlciemmMZ-QXguZ_check-sandbox.png "Retrieve your sandbox API call")



A successful response will look like so:

![](assets/MtPo9F-842nGytENwXCaN_sandbox-success.png "200 OK Successful sandbox request")
