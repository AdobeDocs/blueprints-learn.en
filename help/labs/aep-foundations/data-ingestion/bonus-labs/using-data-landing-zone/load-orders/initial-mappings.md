...
![](assets/7ry70XWYr2bYtJe5zjW_v_id-times.png "_id, timestamp are two fields that the ML Recommender will not generate the mapping for")
...
![](assets/sV0ke-0RcFdpZvKfxJzNJ_calculat.png "Calculated field for mapping _id will look similar to this. Click Save to save the calculated field")

![](assets/gjHr1I9RfX9NIuy-B2czo_map-the-calculated-field-to-id.png "Map the calculated field to _id")
...
![](assets/TqYEYOCfML2mnAjde38oT_expression-preview.png "Write the following expression and click Preview. NOTE that this value is case-sensitive and must be written exactly this way")

![](assets/pjTGi7bBkLjyWCB3a4yrp_map-the-calculated-field-expression-22instore-22-to-order-devbcacqsource.png)

4\. Map the calculated field expression **"inStore"** to **order.\_devbc.acqSource**

![](assets/r74-rI8dltmScxIdBOR3l_write-th.png "Write the following expression and click Preview. NOTE that this value is case-sensitive and must be written exactly this way")
...
![](assets/VA-Ih-jwYsHps6hnqh-x1_duplicate-mapping-for.png "Duplicate mapping for ")



![](assets/tJE4v0HpQzToD1Hh4Uw6Q_duplicat.png "Duplicate mapping for order._devbc.acqSource since we created a calculated field and have already mapped to it. ")
