...
2. Drag 'n drop and/or upload the **Lab\_Historical\_Orders.json **file to the Data Landing Zone you saved from above.



When uploaded your screen should look like the below screenshot

![](assets/pY-OFVPYjQaPKJxqRwuFh_lab-historical-ordersjson-uploaded-to-dlz.png "Lab_Historical_Orders.json uploaded to DLZ")
...
![](assets/n-ADAXZy_lxxLyKc0x1oi-MxTYbowbaFGcpeaAkRnTS-20241025-021247.png "Sources - Data Landing Zone")
...
2. Click **Next** in the upper right corner of the screen to continue to the next step

![](assets/YlaOXmjTZGeyeWDUAaTAT_select-and-preview-the-lab-historical-orders.png "Select & Preview the Lab_Historical_Orders.json file")

# Setup the Dataflow

1. In the Dataflow detail screen, choose **New dataset**
2. Name the output dataset as **Orders - YourNameHere**
3. Select the schema name **dep: Orders**
...
6. Set the Dataflow name as **Orders – Backfill – YourNameHere**
7. Turn on all the alerts **Sources Dataflow Start/Success/Failure** 

![](assets/dVjB_ojZj1uGhBsSyTQQN_dataflow-details-for-orders.png "Dataflow details for Orders")
