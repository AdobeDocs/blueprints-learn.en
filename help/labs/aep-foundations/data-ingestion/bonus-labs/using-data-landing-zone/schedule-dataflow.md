...
2. Set the **Interval **to 15 i.e. 15 minutes. 
3. Turn the **Backfill **option on. 
...
![](assets/cZzN2Y9EjzGxqBu9ApqhR_scheduling-dataflow-run.png "Scheduling Dataflow Run")

Review the data flow and click **Finish.**

![](assets/446tbhFUXFtJkijBoFHo3_review-final-dataflow.png "Review final dataflow")
...
![](assets/n-ADAXZy_lxxLyKc0x1oi-j-WC_X0IPG15it9HEbl1R-20241025-032327.png "Dataflows sources screen")
