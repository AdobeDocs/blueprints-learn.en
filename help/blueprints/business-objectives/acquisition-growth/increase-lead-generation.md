...
| KPI | Description |
| --- | --- |
| Prospects | Total number of new prospects entering the pipeline |
| Cost Per Lead | Average cost to generate a qualified lead |
| Lead Conversion | Percentage of leads that progress to the next pipeline stage |
