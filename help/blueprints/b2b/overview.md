...
| **[B2B Audience and Profile Activation](b2b-audience-profile-activation.md)** | <ul><li>Create and activate people and account audiences from unified B2B profiles across channels and destinations</li></ul>|<ul><li>Adobe Real-Time Customer Data Platform B2B Edition</li><li>Adobe Journey Optimizer B2B Edition</li><li>Adobe Customer Journey Analytics B2B Edition</li></ul>|
| **[B2B Account Activation](b2b-account-activation.md)** | <ul><li>Activate account audiences to advertising destinations and cloud storage for targeting, sales outreach, and analytics</li></ul>|<ul><li>Adobe Real-Time Customer Data Platform B2B Edition</li></ul>|
