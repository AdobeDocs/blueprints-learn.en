...
1. From the list of activities, select the **Change Dimension **activity

![YZ5InGhaNyqSpaABvTN3m 20251215 164449](assets/yZ5InGhaNyqSpaABvTN3m-20251215-164449.png)
...
1. Under the menu *Reconcilation options* make the sure the *Reconcilation type* is set to **Keys only**
...
If successful jump ahead to the next step -> Save Audience
