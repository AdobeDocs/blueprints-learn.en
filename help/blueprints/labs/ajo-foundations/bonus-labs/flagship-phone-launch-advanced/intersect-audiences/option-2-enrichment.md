...
1. From the list of activities, select the **Enrichment **activity. 
...
1. Select the **Customer ID **attribute from the Targeting dimension and then click the **Confirm **button.
...
1. Select **Combine **from the activity list to add it to the canvas
1. Under the Combine options menu select the **Intersection **option and then click the **Continue **button
...
1. On the modal you will select the **Customer ID **field and then click the **Confirm **button
...
1. Your final combine activity configuration should like the below screenshot. If everything looks good click the **Save **button.
...
1. The resulting number should be 76, regardless of which option you selected to combine your two audiences
