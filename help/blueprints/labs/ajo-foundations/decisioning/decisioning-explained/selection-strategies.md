...
- Define a selection strategy and its three components
...
During this lesson you'll apply two full selection strategies (a collection + a ranking formula together) against sample profiles, removing ineligible or out-of-collection phones first, then ranking what's left.
...
- A ranking method can be original priority scores alone, a ranking formula, or an AI model
- Strategy-level eligibility layers on top of any eligibility already set at the decision item level
