...
![Postman download page for installing the desktop app or using the web version](assets/postman-installation-download-page.png)
...
![Postman interface highlighting the sidebar, header, main work area, and footer](assets/postman-installation-interface-overview.png "Postman Interface")
