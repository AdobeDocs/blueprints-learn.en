...
![](assets/H-GtAst5TJj95cUiscUTi_click-on-the-step-4-create-customer-account-schema.png)
...
![](assets/3e-XAFlOXmYeqVnkq6FJ5_empty-schema-api-body.png "Empty Schema API Body")



4\. Review your final body and ensure it looks similar to this

![](assets/4yeNJ82ALNZFtL7Obi3w4_example-of-final-body-payload.png "Example of final body payload")
...
2. Execute the API by clicking the `Send` button
...
![](assets/KIkCUWK7VWbN4jN7bP-wy_sample-response-from-executing-the-step-4-api.png "Sample response from executing the Step 4 API")
...
2. Save the values somewhere so that you can reuse them later
