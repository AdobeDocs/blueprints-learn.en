...
2. Execute by clicking the `Send` button

![](assets/liFeetB8YVlttuHO_b9g7_step-3-get-profile-class-api-request.jpeg "Step 3 - Get Profile Class API Request")
...
2. Copy the `$id` for the `XDM Individual Profile` class and save it somewhere you can reference later.

![](assets/mKLJKZdVyUCdspPQKmUXd_xdm-individual-profile-class.png "XDM Individual Profile Class")
