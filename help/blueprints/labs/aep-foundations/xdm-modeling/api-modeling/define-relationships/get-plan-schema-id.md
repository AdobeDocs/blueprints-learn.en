...
![](assets/2WgUimjBRcQiUeBTOFrvq_step-1-get-lookup-schemas.jpeg "Step 1 - Get Lookup Schemas")
...
2. Copy the `$id` of the schema and save it somewhere for future reference

![](assets/3__JkA-0UjRCfQ-tCmSus_dep-lookup-plan-schema-sid.png "dep: Lookup Plan schema $id")
