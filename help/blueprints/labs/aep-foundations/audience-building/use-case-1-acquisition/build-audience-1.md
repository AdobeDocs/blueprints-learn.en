...
![](assets/LVT9qiIXxVZaVJ3UqcxOc_click-on.png)
...
2. The exclude clause “no active iPhone 14/Pixel 7” We will go over the ramifications of this at the end. 
...
![](assets/Ht9q_ek1cGeisQd9hKALh_do-a-search-for-order-in-the-events-tab-on-the-left-rail.png)
...
![](assets/8rycT7n9l00yXr8yi9d_C_let-s-use-order-placed-event-type-card-and-drag-that-onto-the-canvas.png)
...
>
![](assets/8avAz46GtxZh6iHmX9ay9_in-a-new-audience-go-into-xdm-experience-event-and-drag-on-event-type.png)
>
>Filtering using Event Type cards is the same as filtering using the Event Type Field
>
![](assets/Yc-xLQf61yJereT6AD4cp_the-same-as-filtering-using-the-event-type-fiel.png)
>
...
![](assets/I8AZCC7S7gdMn_l9WbTFv_again-another-reason-for-good-descriptions.png)
...
![](assets/4aq_drG53WgMychk4qtND_we-are-l.png)
...
![](assets/3ZPLlvFQtgiIA3W6ONpjT_turn-22show-only-fields-with-data-22-on.png)
...
![](assets/Mj0LvOqifBULCKbjeDw43_drill-do.png)

Model looks like it, but doesn't have any descriptions.

Drag it onto the Placed Event Card.

![](assets/_P7s04WPQDpIS7LhDLmmk_drag-it-onto-the-placed-event-card.png)

Add iPhone 14

![](assets/mgRCKEBQz1LXXH03xapHt_add-iphone-14.png)
...
![](assets/Gs5HAM2FEwL3nKu-AbR7R_change-evaluation-method-to-streamin.png)

**Save Audience** as “*Placed Order iPhone 14*” 

Click the blue button **Activate Audience** to Destination

![](assets/J3hcjzfXTYwIB31LpNFEC_activate-audience-to-destination.png)

Select the **Streaming DEP Webhook** Destination and click Next

![](assets/qsAnaZWLA6LS1cBI9HvMW_streaming-dep-webhook-destination.png)
...
>
>
![](assets/ygIISO3aQoflsdYw5tMdy_called-product-list-items-in-our-example.png)
>
