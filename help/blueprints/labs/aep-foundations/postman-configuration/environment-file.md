...
![Import buttonenvironmental file.png "Import Button"](assets/uCY1kQDFa7lfHFWTuKtvr_import-buttonenvironmental-file.png "Import Button")



![Import button overlayenvironmental file.png "Import Button Overlay"](assets/ygbntV4Irq-weJ24YD3c1_import-button-overlayenvironmental-file.png "Import Button Overlay")
...
![Aep bootcamp environmentenvironmental file.png "AEP Bootcamp Environment"](assets/T0-r1SaY5Q3ZCm3RxsWmZ_aep-bootcamp-environmentenvironmental-file.png "AEP Bootcamp Environment")
...
![ZlZXC6 environment file with developer project valuesenvironmental file.png "Environment File with Developer Project values"](assets/wEQbeKucQCHY8m_ZlZXC6_environment-file-with-developer-project-valuesenvironmental-file.png "Environment File with Developer Project values")
...
![Environment file with sandbox nameenvironmental file.png "Environment File with SANDBOX NAME"](assets/EyshNCyi8TRJ8wRkfhVgK_environment-file-with-sandbox-nameenvironmental-file.png "Environment File with SANDBOX_NAME")
