...
1. Understanding passthrough mappings
1. Fixing ML-generated passthrough mappings
1. Using source data preview to check any data quality issues
1. Scheduling a dataflow run
