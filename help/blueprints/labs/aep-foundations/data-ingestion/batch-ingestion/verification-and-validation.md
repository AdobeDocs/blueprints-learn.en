...
![](assets/hrf-PK5SbKm6lzh8DVqd5_access-the-dataset-in-the-datasets-pane.png "Access the dataset in the Datasets pane")



3\. Click on **Preview dataset **in the top right corner

![](assets/iuAD5bK3hAX5xjkY5ncPO_preview-dataset-is-in-the-top-right-cornerverification-and-validation.png "Preview dataset is in the top right corner")



4\. **Verify** and** validate **the same records that you ingested by clicking on the left pane showing the schema hierarchy.

![](assets/HoaBW4lMW5bRCQCNVzlqJ_verify-and-validate-the-dataset.png)
...
![](assets/n-ADAXZy_lxxLyKc0x1oi-Hyifs3cMQ76cz5HM-EUrq-20241025-011617.png "Copy the table name")
...
![](assets/B92Vj2-3kGpBP37IoXmE0_access-the-query-editor.png)
...
![](assets/n-ADAXZy_lxxLyKc0x1oi-_5jgN_14oDYtoLIu1Ot4m-20241025-012023.png "Query editor interface")
