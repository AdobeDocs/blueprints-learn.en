...
![](assets/3jtwSfa5SDlyVDiYJasg__re-validate-mappings-using-the-validate-button.png "Re-validate mappings using the validate button")
...
![](assets/_jS-lxJiI_fqVvFexXvh3_personnamelastname-is-mapped-to-twice-in-this-mapping.png "person.name.lastName is mapped to twice in this mapping")

![](assets/W2yNSyWFq2Eo3BGOzsfg9_plan-nam.png)
...
![](assets/RfWELh4y6RWlYqzs5N1sW_email-seems-to-be-mapped-correctly-but-is-incorrect-as-per-requirements.png "email seems to be mapped correctly but is incorrect as per requirements")

And this one where **email\_optin **is incorrectly mapping to the wrong consent object

![](assets/WtXdsgFemj1REbMSd1Nf5_email-op.png "email_optin seems to be mapped correctly but is incorrect as per requirements")
...
2. In the target schema that options to the right choose the appropriate target field and select the name field **\_devbc.plan.name**
