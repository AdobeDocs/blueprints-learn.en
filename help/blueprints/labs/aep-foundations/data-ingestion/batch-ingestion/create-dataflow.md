...
![](assets/n-ADAXZy_lxxLyKc0x1oi-TszWAFWg87ho6qADimcJ6-20241025-025702.png "Access the Data Landing Zone")
...
6. Set the Dataflow name as **Customer Account Batch – \<Your Initials>** 
7. Turn on all the alerts **Sources Dataflow Start/Success/Failure**

![](assets/m5EDAfE2qxpKR2LyFgXjF_data-flow-details.png "Data Flow Details")
...
2. Drag 'n drop and/or upload the **Lab\_Customer\_Account.csv **file in the UI.  When done your screen should look like below.

![](assets/pjFHpQeQwNQh8gy0MndQG_accessin.png "Accessing the Azure Storage Explorer files within Adobe Experience Platform")
