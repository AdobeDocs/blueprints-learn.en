...
2. On 1st launch accept the End user License Agreement

![](assets/rT5YtfnGtfBojx3BQ9sFo_end-user-license-agreement-screen.png "End-User License Agreement screen")
...
![](assets/nty4xy0HBzztOzqmfJ787_choose-the-resource-as-shown-above.png)



2\. Select **Shared access signature URL (SAS) **and click **Next**

![](assets/rZAMQkVlythnjbt8d6TvE_choose-the-sas-url-option-as-the-mode-of-connection.png "Choose the SAS URL option as the mode of connection")
...
![](assets/D84_ifzxEsIUJ1z1_Vaq0_name-the-connection.png "Name the connection")
...
![](assets/n-ADAXZy_lxxLyKc0x1oi-JqCymPDJfxfQrCz7YwkDW-20241025-020415.png "Access Data Landing Zone Source Card in Adobe Experience Platform")
...
![](assets/wVoRej68xvZv5Sm7g68_k_copy-the.png "Copy the SAS URL credentials from Adobe Experience Platform and copy it onto Azure Storage Explorer")



6\. Click **Next **to continue

![](assets/DuFA2rMn_kCGVSqbCGrw0_copy-sas-url-credentials-into-the-sas-url-section-in-connection-info.png "Copy SAS URL credentials into the SAS URL section in connection info")



7\. On the Summary screen click **Connect**

![](assets/H5E6vkWiawIvTF_y9qs3O_connect-screen.png "Connect screen")



You should now see a screen that looks like below

![](assets/sQeP_UVRldu-H79PE898a_successfully-connected-account.png)
